...
作为脑机接口领域的一个重要新兴分支，片上脑机接口是一种通过编解码技术及刺激反馈系统实现与外界信息交互的技术，对于探索新一代生命体与非生命体融合交互，形成在混合智能、类脑计算、医疗康复等国家重大需求领域新应用方面具有重要的意义。团队开发了一款适用于三维片上脑、刺激范式多元、智能性强、多任务模态的集成共享型片上脑机交互系统 - MetaBOC 系统，提供可自主设计和调控的实验平台。